...
std::string ProfileFor(const std::string& email_string) {
    std::string res{};
...
std::string ProfileEncrypt(const std::string& email_string, const std::string& key_string) {
    std::array<uint8_t, 16> key{
    ...
    std::string input_hex_string{StringToHexString(ProfileFor(email_string))};
...
int main() {
    ...
    std::string block_size_test{ProfileEncrypt(std::string(10, ' ') + "admin" + std::string(11, '\0'), key_string)};

    std::string admin_block_string{block_size_test.substr(16, 16)};

    std::cout << ProfileFor("mysuperdupersecrets@email.com").length() << std::endl;

    std::string encrypted_profile_without_role{ProfileEncrypt("mysuperdupersecrets@email.com", key_string).substr(0, 48)};

    std::string encrypted_admin_profile{encrypted_profile_without_role + admin_block_string};
    ...
    std::cout << AES128ECBDecrypt(StringToHexString(encrypted_admin_profile), key, 10) << std::endl;
